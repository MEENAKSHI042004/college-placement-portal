...
class StudentProfile(models.Model):
    ...
    placement_status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='not_placed', db_index=True)
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)

    class Meta:
        indexes = [
            models.Index(fields=['branch', 'cgpa']),
            models.Index(fields=['placement_status', 'branch']),
            models.Index(fields=['year', 'branch']),
        ]
